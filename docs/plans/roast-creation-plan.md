...
**Tech Stack:** Vercel AI SDK (`ai` + `@ai-sdk/google`), tRPC v11, Drizzle ORM, Zod, Next.js 16 App Router
...
Run: `npm add ai @ai-sdk/google`

**Step 2: Add Google API key to `.env`**

Add `GOOGLE_GENERATIVE_AI_API_KEY=sk-...` to `.env` (user must provide their own key).
...
```
feat: add Vercel AI SDK and Google provider
```
...
**Files:**
- Modify: `app/trpc/routers/roast.ts`
