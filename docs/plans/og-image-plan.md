...
Run: `npm add @takumi-rs/image-response`
...
```bash
git add package.json npm-lock.json next.config.ts
...
**Files:**
- Create: `components/og/roast-og-image.tsx`
...
```bash
git add components/og/roast-og-image.tsx
...
**Files:**
- Create: `app/roast/[id]/opengraph-image/route.tsx`
...
```bash
git add app/roast/[id]/opengraph-image/route.tsx
...
**Files:**
- Modify: `app/roast/[id]/page.tsx:1-17`
